...
| 設定ファイル | 環境名 | `local.yaml`, `prod.yaml` |
...
> **参考**: [Hydra 公式ドキュメント](https://hydra.cc/docs/intro/) / [OmegaConf 公式ドキュメント](https://omegaconf.readthedocs.io/)
...
| **Hydra or OmegaConf 導入**: `_base_` + `local` + `prod` 階層テンプレート作成 | インフラ担当 | 高 | 1週間 |
...
> **参考**: [DVC Data Registry](https://dvc.org/doc/use-cases/data-registry) / [Cookiecutter テンプレート](https://github.com/cookiecutter/cookiecutter)
